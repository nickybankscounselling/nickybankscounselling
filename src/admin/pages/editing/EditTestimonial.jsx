...
export function EditTestimonial({ variables }) {
	...
	const deletePost = async (event) => {
		await DeleteData(event, setButtons, buttons, 'testimonials/' + testimonial.testimonialId,
				'testimonialId');
		navigate('/' + variables.adminPath + '/testimonials')
	}
	...
	return (
			<div>
				<EditHeader backUrl={ '/' + variables.adminPath + '/testimonials' } deletePost={ deletePost } saveDraft={ saveDraft }
