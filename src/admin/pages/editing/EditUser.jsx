...
import {HandleChange, PostData} from "../../functions/PostData.jsx";
import {useNavigate, useParams} from "react-router-dom";
import {getPermissions, getUsers} from "../../api.jsx";

export function EditUser({ variables }) {
	...
	const handleSubmit = async ( event ) => {
		...
		data === 'success' && navigate('/' + variables.adminPath + '/users');
	}
	
	return (
			<div>
				<a href={'/' + variables.adminPath + '/users'}><i className="fa-solid fa-arrow-left fa-2xl"></i></a>
