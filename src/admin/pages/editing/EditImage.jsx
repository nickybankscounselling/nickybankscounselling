...
import {DeleteData, HandleChange, PostData} from "../../functions/PostData.jsx";
import {useEffect, useState} from "react";
import {useParams} from "react-router-dom";
import {getImageById} from "../../api.jsx";

export function EditImage({ variables }) {
	...
	return (
			<div>
				<EditHeader deletePost={ deleteImg } publishPost={ saveImg } backUrl={'/' + variables.adminPath + '/images'}
							buttons={ buttons } showDelete={ true } showSave={ false } variables={variables} />
